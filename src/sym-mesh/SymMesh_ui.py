...
class SymMeshUI(dockable, QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.sym_mesh.revert_value = 100
        ...
        self.select_non_symmetrical_vtcs_pB.clicked.connect(self.select_non_mirrored_vertices)
    ...
    def buildUI(self):
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.get_target_pB.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.get_selected_vtcs_pB.sizePolicy().hasHeightForWidth())
        ...
        self.select_non_symmetrical_vtcs_pB = QtWidgets.QPushButton('Select Non Symmetrical Vtcs')
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.select_non_symmetrical_vtcs_pB.sizePolicy().hasHeightForWidth())
        ...
        self.select_non_symmetrical_vtcs_pB.setObjectName("select_non_symmetrical_vtcs_pB")
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.select_stored_vtcs_pB.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.revert_value_slider.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.revert_value_sB.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.revert_to_base_pB.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHeightForWidth(self.revert_to_base_live_pB.sizePolicy().hasHeightForWidth())
        ...
        self.revert_to_base_pB.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Revert selected mesh or vertices to base, from registered position.", None))
        self.revert_to_base_live_pB.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Revert selected mesh or vertices to base, from current position.", None))
        self.undo_pB.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Revert selected mesh or vertices to base, from current position.", None))

    def get_spinBox_value(self):
        """Get spinBox value and set slider value"""
        value = self.revert_value_slider.value()

        self.sym_mesh.revert_value = value
